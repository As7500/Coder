      ...
      <div className="track-headerr">
        <div className="track-container">
          <div className="track-flex">
            ...
            <p>
              <span className="track-p">Join C++ Community</span> python track
              that help you learn more about python programming by providing
          ...
          <div className="graphics">
            <img className="graph-icon" src={cpp} />
          </div>
        </div>
      </div>
              ...
              <div className="java-expander">
                <div className="content">
                  <p className="content-pp">
                    ...
                    programming language developed by Bjarne Stroustrup starting
                    in 1979 at Bell Labs. It is immensely popular, particularly
                    for applications that require speed and/or access to some
                    low-level features. It is considered to be an intermediate
                    level language, as it encapsulates both high and low level
                    language features. C++ supports procedural, object-oriented,
                    functional and generic programming. Compilers for C++ are
                    available for essentially every platform, including Windows,
                    Mac OS, and Linux.
                  </p>
                </div>
              </div>
